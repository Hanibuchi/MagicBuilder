...
public class Downward : SpellBase
{
    ...
    {
        DisplayAimingLineForNextSpells(GetNextSpellOffsets(), wandSpells, currentSpellIndex, upward ? 90 : -90, strength, casterPosition, clearLine);
    }
    ...
    {
        FireSpellForNextSpells(GetNextSpellOffsets(), wandSpells, currentSpellIndex, upward ? 90 : -90, strength, context);
    }
